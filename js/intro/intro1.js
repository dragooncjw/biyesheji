    ...
    $(function(){
        ...
        intro.setOptions({
            steps: [
                ...
                {
                    element: '#emergency',
                    intro: '<p class="h4 text-uc"><strong>4:Emergency button</strong></p><p>Click here and the system will shut dowm immediately.</p>',
                    position: 'top'
                },
                {
                    element: '#fold',
                    intro: '<p class="h4 text-uc"><strong>5: Click to fold</strong></p><p>Click here and the nav will fold.</p>',
                    position: 'top'
                }
            ],
            showBullets: true
